...
Includes API routes for health, projects, scans, and documentation.
"""
...
schema_view = get_schema_view(
    openapi.Info(
        title="Code Quality Monitoring API",
        default_version="v1",
        description="REST API to monitor code quality via GitLab and SonarQube",
    ),
    public=True,
